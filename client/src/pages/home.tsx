...
import { ShoppingBag, HandHeart, Star, ChevronDown, Check, Heart, CalendarPlus, NotebookPen } from "lucide-react";
...
const Home = () => {
  ...
  const newsletterMutation = useMutation({
    ...
    onError: () => {
      toast({
        title: "Fehler",
        description: "Die Newsletter-Anmeldung konnte nicht verarbeitet werden.",
        variant: "destructive",
      });
    },
  });
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="prose prose-lg mx-auto text-charcoal leading-relaxed">
              ...
              <p className="mb-6">
                Hier vereinen sich Kunstharz, Silber und Bronze zu einem glanzvollen Ausdruck von Natur und Erinnerungen. Jede Kreation ist ein kleines Stück Märchen, das die verborgenen Geschichten der Natur erzählt und dir nahebringt.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-charcoal max-w-3xl mx-auto">
              In meinem Atelier entstehen Schmuckstücke, die die Magie der Natur und das Geheimnisvolle des Waldes in sich tragen. 
              Jede Kreation aus Kunstharz, Silber und Bronze ist ein einzigartiges Unikat.
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <Link href="/shop">
              <Button className="bg-forest hover:bg-forest/90 text-white px-8 py-3 rounded-full font-semibold transition-all duration-300" data-testid="button-view-all-products">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-charcoal mb-8 leading-relaxed">
                  Entdecke die Kunst des Schmuckdesigns mit UV-Resin! In meinen Kursen erlernst du die Grundlagen des Kunstharz-Giessens 
                  und gestaltest dein eigenes Schmuckstück - von der ersten Idee bis zur fertigen Kreation.
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-charcoal">Grundlagen des UV-Resin Giessens</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-sage/20 rounded-full flex items-center justify-center">
                      <Check className="text-sage w-4 h-4" />
                    </div>
                    <span className="text-charcoal">Persönliche Betreuung in kleinen Gruppen</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-sage/20 rounded-full flex items-center justify-center">
                      <Check className="text-sage w-4 h-4" />
                    </div>
                    <span className="text-charcoal">Alle Materialien inklusive</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-sage/20 rounded-full flex items-center justify-center">
                      <Check className="text-sage w-4 h-4" />
                    </div>
                    <span className="text-charcoal">Eigenes Schmuckstück mitnehmen</span>
                  </div>
                </div>

                <div className="space-y-4">
                  <Link href="/kurse">
                    <Button className="bg-gold hover:bg-gold/90 text-white px-8 py-3 rounded-full font-semibold transition-all duration-300" data-testid="button-book-course">
                  ...
                  <div className="text-sm text-charcoal/70">
                    ...
                    Kurse finden regelmässig statt. Kontaktiere mich für aktuelle Termine.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-charcoal mb-6 leading-relaxed">
                Bewahre die Erinnerungen an deine Liebsten mit individuell gefertigten Schmuckstücken.
              </p>
              <p className="text-charcoal mb-8 leading-relaxed">
                Ob Haare, Asche oder andere wertvolle Erinnerungen - ich fange sie in Kunstharz ein und verwandle sie in ein besonderes Andenken, 
                das dir für immer nah ist. Diese Spezialanfertigungen sind mehr als Schmuck, sie sind ein bleibendes Stück Ewigkeit.
              </p>
              ...
              <div className="bg-white rounded-lg p-6 mb-8 shadow-sm">
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-charcoal">Beratungsgespräch über deine Wünsche</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-gold text-white rounded-full flex items-center justify-center text-sm font-semibold mt-1">2</div>
                    <span className="text-charcoal">Entwurf und Materialauswahl</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-gold text-white rounded-full flex items-center justify-center text-sm font-semibold mt-1">3</div>
                    <span className="text-charcoal">Handwerkliche Umsetzung in meinem Atelier</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-gold text-white rounded-full flex items-center justify-center text-sm font-semibold mt-1">4</div>
                    <span className="text-charcoal">Dein einzigartiges Erinnerungsstück</span>
                  </div>
                </div>
              </div>

              <Link href="/kontakt">
                <Button className="bg-forest hover:bg-forest/90 text-white px-8 py-3 rounded-full font-semibold transition-all duration-300" data-testid="button-request-commission">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-cream rounded-lg p-6 shadow-sm">
              <CardContent className="p-0">
                ...
                <p className="text-charcoal mb-4 italic">
                  "Mein Anhänger mit den getrockneten Blüten ist einfach wunderschön. Jedes Mal, wenn ich ihn trage, erinnert er mich an unseren Hochzeitstag im Wald."
                </p>
            ...
            <Card className="bg-cream rounded-lg p-6 shadow-sm">
              <CardContent className="p-0">
                ...
                <p className="text-charcoal mb-4 italic">
                  "Der UV-Resin Kurs war fantastisch! Ich konnte mein eigenes Schmuckstück kreieren und habe so viel gelernt. Sehr empfehlenswert!"
                </p>
            ...
            <Card className="bg-cream rounded-lg p-6 shadow-sm">
              <CardContent className="p-0">
                ...
                <p className="text-charcoal mb-4 italic">
                  "Die Sonderanfertigung mit den Haaren meiner verstorbenen Katze ist ein wahrer Schatz. Vielen Dank für die einfühlsame Beratung."
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-cream mb-8 text-lg">
              Erfahre als Erste von neuen Kreationen, Kurs-Terminen und besonderen Angeboten.
            </p>
